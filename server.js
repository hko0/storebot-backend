...
function buildSystemPrompt(ctx, store, total) {
  ...
  const extras = [
    ...
    store.whatsapp ? `## واتساب الدعم: رقم الواتساب هو ${store.whatsapp.replace(/\D/g,"")} — اذكر الرقم فقط بدون أي روابط إذا سأل العميل.` : "",
...
- إذا سأل عن رقم الواتساب أو الدعم، اذكر الرقم فقط بدون أي روابط أو تنسيق: مثال "رقم الدعم: 966555734863"
- لا تولّد روابط واتساب أبداً — الويدجت يتولى ذلك تلقائياً.
